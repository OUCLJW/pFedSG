...
def separate_data(data, num_clients, num_classes, niid, balance, partition=None, class_per_client=2):
    ...
    if partition == 'pat':
        ...
        for i in range(num_classes):
            ...
            if num_selected_clients == 0:
                raise ValueError(f"No clients selected for class {i}, cannot divide by zero.")
